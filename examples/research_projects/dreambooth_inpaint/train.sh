...
# export OUTPUT_DIR="/content/drive/MyDrive/clothestest-v3"
...
export OUTPUT_DIR="/content/drive/MyDrive/clothestest-swimoutlet"
...
accelerate launch train_dreambooth_inpaint_clothes.py \
  ...
  --instance_prompt="a person with a bikini" \
  --resolution=512 \
  --train_batch_size=1 \
